    ...
    public class EditModel : PageModel
    {
        ...
        {   
            ...
            Input = new Profile
            {
                ...
                ChurchDenomination = currentUser.ChurchDenomination,
                ChurchWebsite = currentUser.ChurchWebsite,
        ...
        // Method for udpated profile information
        ...
        { 
            try
            {
                ...
                user.ChurchName = Input.ChurchName ?? string.Empty;
                user.ChurchDenomination = Input.ChurchDenomination ?? string.Empty;
                user.ChurchWebsite = Input.ChurchWebsite ?? string.Empty;
