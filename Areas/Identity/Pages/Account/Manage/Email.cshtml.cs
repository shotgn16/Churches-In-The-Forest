...
namespace ForestChurches.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        public EmailModel(
            ...
            IEmailSender emailSender, iEmail mailRepository)
        {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await _mailRepository.StartEmailAsync(Input.NewEmail, userData, "Confirm your email", "./templates/confirm_email.html");
